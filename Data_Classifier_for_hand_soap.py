...
# Loading the Data
df = pd.read_excel(r'C:\Users\jun63\Downloads\Science_fair_algo\Dataset_Science_Fair_2025_hand_soap - Copy.xlsx') 
...
input = df.iloc[:, 1:-1]            # We drop the first column and the two last ones. 
print('\nInput values are:') 
print(input.head())   
output = df.loc[:, 'concentration']   # Output Y is the last column  
print('\nThe output value is:') 
print(output.head()) 
...
learning_rate = 0.01 
output_size = 1           # The output is prediction results for three types of Irises.  should it be like 4 or more like 100 bc its guessing from 0-100
...
def test_species(): 
    ...
    labels_length = 4 # how many labels of Irises we have. = 3 in our database. 
    ...
    label_list = list(concentration.keys()) 
